\paragraph*{UC7}    %possibile incoerenza, i badge in itinere o alla fine?
\begin{center}
    ...
    \end{tabu}
\end{center}
\useSvgWithCaption{Images/UML/sequenceDiagram/sequenceDiagramStudentGetsAwardedWithBadge.svg}{0.65}{0.65}{UC7 Sequence Diagram - Student gets awarded with badge}
\clearpage