...
\begin{center}
    ...
    \end{tabu}
\end{center}
\useSvgWithCaption{Images/UML/sequenceDiagram/sequenceDiagramStudentGetsAwardedWithBadge.svg}{0.65}{0.65}{UC7 Sequence Diagram - Student gets awarded with bagde}
\clearpage