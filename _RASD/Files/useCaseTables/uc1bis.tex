\paragraph*{UC1Ulterior - need to fix numbering}
\begin{center}
    ...
    \end{tabu}
\end{center}
\useSvgWithCaption{./Images/UML/sequenceDiagram/sequenceDiagramUC1bis.svg}{1.0}{1.0}{UC1bis Sequence Diagram - User login}
\clearpage