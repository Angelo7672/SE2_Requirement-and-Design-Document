\paragraph{UC1 - User signs in to the platform} \label{uc:uc1} 
   %questo lo toglierei tanto un user non puo' loggarsi come tale
\begin{center}
...
\paragraph*{UC1a - Student signs in to the platform}
\begin{center}
    \begin{tabu}{|X[.2]|X|} \hline \everyrow{\hline}
...
\useSvgWithCaption{./Images/UML/sequenceDiagram/sequenceDiagramUC1a.svg}{1.0}{1.0}{UC1, UC1a, UC1b Sequence Diagram - User, Student or Educator, signs in to the platform}
\clearpage