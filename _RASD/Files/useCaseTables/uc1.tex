\paragraph*{UC1}    %questo lo toglierei tanto un user non puo' loggarsi come tale
\begin{center}
...
\begin{center}
    ...
    \end{tabu}
\end{center}
\useSvgWithCaption{./Images/UML/sequenceDiagram/sequenceDiagramUC1.svg}{1.0}{1.0}{UC1 Sequence Diagram - User Registration to the platform}
\clearpage