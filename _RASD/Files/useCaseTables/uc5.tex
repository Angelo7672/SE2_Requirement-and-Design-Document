...
\begin{center}
    ...
    \end{tabu}
\end{center}
\useSvgWithCaption{Images/UML/sequenceDiagram/sequenceDiagramEducatorCreatesBattle.svg}{1.0}{1.0}{UC5 Sequence Diagram - Educator adds a battle to the tournament}
\clearpage