...
\begin{center}
    \begin{tabu}{|X[.2]|X|} \hline \everyrow{\hline}
        ...
        \specialReqLabel & -\\ 
    \end{tabu}
    \tableEntryByLabel{uc:uc11}
\end{center}
\useSvgWithCaption{Images/UML/sequenceDiagram/sequenceDiagramUC11.svg}{0.65}{0.65}{UC11 Sequence Diagram - User searches for other Users}
