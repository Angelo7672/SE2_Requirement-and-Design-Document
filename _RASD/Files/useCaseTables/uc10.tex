...
\begin{center}
    ...
    \end{tabu}
    \tableEntryByLabel{uc:uc10}
\end{center} 
\useSvgWithCaption{Images/UML/sequenceDiagram/sequenceDiagramUC10.svg}{0.65}{0.65}{UC10 Sequence Diagram - Educator manually evaluates code}
\clearpage