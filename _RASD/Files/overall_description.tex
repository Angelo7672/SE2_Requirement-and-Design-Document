...
\begin{enumerate}[label=$\bullet$ \textbf{SC\arabic*:}]
    ...
    \item \textbf{Educator wants to create a Battle}\\Jude oversees a tournament as an educator. She now wants to put her students to the test by suggesting a battle. When she opened the CKB Web App, she was taken to the page where she 
    ...
    \item \textbf{Educator wants to create a Badge}\\Beniamino is an educator, and he wants to design a badge for a tournament he oversees. He open the CKB Web App on his home page and go to the page with the managed tournaments list.
