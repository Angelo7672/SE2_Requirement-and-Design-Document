...
\begin{enumerate}[label=\textbf{GP\arabic*:}]
...
\begin{enumerate}[label=\textbf{GE\arabic*:}]
...
\begin{enumerate}[label=$\bullet$]
    ...
    \begin{itemize}
        \item First release
    \end{itemize}
    \release{1.1}{2024-01-7}
    \begin{itemize}
        \item Tweaked \nameref{uc:uc1a} Sequence Diagram
        \item Tweaked \nameref{uc:uc1b} Sequence Diagram
        \item Tweaked \nameref{uc:uc3}
        \item Tweaked \nameref{uc:uc4}
        \item Tweaked \nameref{uc:uc7}
        \item Tweaked \nameref{uc:uc9}
        \item Better Explained \ref{req:eval}:  \nameref{req:eval}
    \end{itemize}
\end{enumerate}
