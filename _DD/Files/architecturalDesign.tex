...
\begin{enumerate}
    \item \textbf{Sign In Manager} It is the manager in charge of allow Users to sign in into the Platform or sign out, through proper interface.
    ...
    \item \textbf{Badge Manager} Allows Educators to create a Badge with corresponding parameters and criteria. Moreover, it assigns Badges to Students who can be awarded.
    \item \textbf{Battle Manager} This component, which authenticates the user gaining access, is in charge of sending out invites to other students and obtaining the battle score via an appropriate interface. It also 
    includes the RMP repository link for cloning. Ultimately, the component enables Students to participate in the Battle.
    \item \textbf{Tournament Manager} Educators will use the given interface to create a Tournament and invite other Educators to participate. This component also permits Teams to compete, maintains the ranking, and makes
    Tournament information available.
    \item \textbf{Account Manager} It is in charge of recruiting all information about a single Account, allowing the owner to delete or update the Account with new personal data.
...
%TIER
CAs previously said, when CKB is deployed, it will include a Four Tiers Architecture that both reflects and extends upon the three Layers that rationally make up CKB.
...
\useSvgWithCaption{./Images/sequenceDiagrams/logIn.svg}{1.0}{1.0}{Log In Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/inviteEducator.svg}{1.0}{1.0}{Invite an Educator Sequence Diagram}

\newpage
\subsubsection{Invite Student}
\useSvgWithCaption{./Images/sequenceDiagrams/inviteStudent.svg}{1.0}{1.0}{Invite a Student Sequence Diagram}

\newpage
\subsubsection{Receive Educator Invitation}
\useSvgWithCaption{./Images/sequenceDiagrams/receiveEducatorInvitation.svg}{1.0}{1.0}{Receive an Educator invitation Sequence Diagram}

\newpage
\subsubsection{Receive Student Invitation}
\useSvgWithCaption{./Images/sequenceDiagrams/receiveStudentInvitation.svg}{1.0}{1.0}{Receive a Student Sequence Diagram}

\newpage
\subsubsection{Create a Tournament}
\useSvgWithCaption{./Images/sequenceDiagrams/createATournament.svg}{1.0}{1.0}{Create a Tournament Sequence Diagram}

\newpage
\subsubsection{Create a Battle}
\useSvgWithCaption{./Images/sequenceDiagrams/createABattle.svg}{1.0}{1.0}{Create a Battle Sequence Diagram}

\newpage
\subsubsection{Join a Battle}
\useSvgWithCaption{./Images/sequenceDiagrams/joinABattle.svg}{1.0}{1.0}{Join a Battle Sequence Diagram}

\newpage
\subsubsection{Create a Badge}
\useSvgWithCaption{./Images/sequenceDiagrams/createABadge.svg}{1.0}{1.0}{Create a Badge Sequence Diagram}

\newpage
\subsubsection{Assign a Badge}
\useSvgWithCaption{./Images/sequenceDiagrams/assignABadge.svg}{1.0}{1.0}{Assign a Badge Sequence Diagram}

\newpage
\subsubsection{Evaluate Code}
\useSvgWithCaption{./Images/sequenceDiagrams/evaluateCode.svg}{1.0}{1.0}{Evaluate Code Sequence Diagram}

\newpage
\subsubsection{Educator Manual Evaluate Code}
\useSvgWithCaption{./Images/sequenceDiagrams/updateTournamentScoreEducator.svg}{1.0}{1.0}{Educator Manual Evaluate Code Sequence Diagram}

\newpage
\subsubsection{User searches for Users}
\useSvgWithCaption{./Images/sequenceDiagrams/userSearchesForUsers.svg}{1.0}{1.0}{User searches for Users Sequence Diagram}

\newpage
\subsubsection{Student searches for Tournaments}
\useSvgWithCaption{./Images/sequenceDiagrams/studentSearchesForTournament.svg}{1.0}{1.0}{Student searches for Tournaments Sequence Diagram}
