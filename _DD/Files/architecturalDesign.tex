...
\useSvgWithCaption{./Images/sequenceDiagrams/joinATournament.svg}{1.35}{1.35}{Join a Tournament Sequence Diagram}
...
\begin{enumerate}
    \item \textbf{Controller Interface}
            \begin{enumerate}[label=$\bullet$]
                \item \textbf{signIn(signInData: SignInData): Void}
