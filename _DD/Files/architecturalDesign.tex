...
\useSvgWithCaption{./Images/componentDiagrams/componentDiagram.svg}{1.0}{1.0}{Component Diagram}
\newpage

\paragraph{Client}
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramClient.svg}{0.5}{0.5}{Client Component Diagram}
...
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramApplicationServer.svg}{1.0}{1.0}{Application Server Component Diagram}
\begin{enumerate}
...
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramDBMSServer.svg}{0.5}{0.5}{Client Component Diagram}
