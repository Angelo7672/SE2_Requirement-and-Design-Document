...
\paragraph{Client}
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramClient.svg}{1.0}{1.0}{Client Component Diagram}
\newpage

\paragraph{Web Server}
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramWebServer.svg}{1.0}{1.0}{Web Server Component Diagram}
...
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramDBMSServer.svg}{1.0}{1.0}{Client Component Diagram}
...
%INVITE EDUCATOR SEQUENCE DIAGRAM TO ADD
\subsubsection{Invite Student}
%INVITE STUDENT SEQUENCE DIAGRAM TO ADD
\subsubsection{Receive Educator Invitation}
%RECEIVE EDUCATOR INVITATION SEQUENCE DIAGRAM TO ADD
\subsubsection{Receive Student Invitation}
%RECEIVE STUDENT INVITATION SEQUENCE DIAGRAM TO ADD
...
%UPDATE TOURNAMENT SCORE EDUCATOR SEQUENCE DIAGRAM TO ADD
\subsubsection{User searches for Users}
%USER SEARCHES FOR USERS SEQUENCE DIAGRAM TO ADD
\subsubsection{Student searches for Tournaments}
%STUDENT SEARCHES FOR TOURNAMENTS SEQUENCE DIAGRAM TO ADD
