...
The interaction shown below, occurs any time components wants to communicate each other.\\
Where MicroserviceA and MicroserviceB are two generic components, GenericComponent is a microservice, or Web Server or API manager or any component that triggers MicroserviceA to do something in a procedure, and Dispatcher is the dispatcher component.
...
Any time would be needed a communication between an external component, or client and the Web server module, it will happen as described below.
