...
The Dispatcher also manages the DBMS Manager component, better described below, there can be multiple DBMS Managers but is adviseable to keep their lives long and to not to pawn and kill them too frequently. 
