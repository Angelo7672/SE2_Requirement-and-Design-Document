...
\useSvgWithCaption{./Images/componentDiagrams/microserviceArchitecture.svg}{1}{1}{Microservices Architecture}
\newpage
\subsubsection{Component Diagrams}
\useSvgWithCaption{./Images/componentDiagrams/componentDiagram.svg}{1}{1}{Component Diagram}
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramTooSimplified.svg}{1}{1}{Simplified Component Diagram}
\newpage
...
\end{enumerate}
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramWebServer.svg}{0.3}{0.3}{Web Server Component Diagram}
\newpage
...
\end{enumerate}
\newpage
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramApplicationServer.svg}{1}{1}{Application Server Component Diagram}
\newpage
...
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramDBMSServer.svg}{0.3}{0.3}{Client Component Diagram}
...
\useSvgWithCaption{./Images/componentDiagrams/componentDiagramExternalServices.svg}{0.3}{0.3}{External Services Component Diagram}
\newpage
...
\useSvgWithCaption{./Images/sequenceDiagrams/signIn.svg}{1.3}{1.3}{Sign In Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/logIn.svg}{1.4}{1.4}{Log In Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/joinATournament.svg}{1.4}{1.4}{Join a Tournament Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/inviteStudent.svg}{1.4}{1.4}{Invite a Student Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/receiveEducatorInvitation.svg}{1.4}{1.4}{Receive an Educator invitation Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/receiveStudentInvitation.svg}{1.4}{1.4}{Receive a Student Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/createATournament.svg}{1.4}{1.4}{Create a Tournament Sequence Diagram}

\clearpage
\subsubsection{Create a Battle}
\useSvgWithCaption{./Images/sequenceDiagrams/createABattle.svg}{1.4}{1.4}{Create a Battle Sequence Diagram}
...
\useSvgWithCaption{./Images/sequenceDiagrams/createABadge.svg}{1.4}{1.4}{Create a Badge Sequence Diagram}

\clearpage
\subsubsection{Assign a Badge}
\useSvgWithCaption{./Images/sequenceDiagrams/assignABadge.svg}{1.4}{1.4}{Assign a Badge Sequence Diagram}

\clearpage
\subsubsection{Evaluate Code}
\useSvgWithCaption{./Images/sequenceDiagrams/evaluateCode.svg}{1.4}{1.4}{Evaluate Code Sequence Diagram}

\clearpage
\subsubsection{Educator Manual Evaluate Code}
\useSvgWithCaption{./Images/sequenceDiagrams/updateTournamentScoreEducator.svg}{1.4}{1.4}{Educator Manual Evaluate Code Sequence Diagram}

\clearpage
\subsubsection{User searches for Users}
\useSvgWithCaption{./Images/sequenceDiagrams/userSearchesForUsers.svg}{1.4}{1.4}{User searches for Users Sequence Diagram}

\clearpage
\subsubsection{Student searches for Tournaments}
\useSvgWithCaption{./Images/sequenceDiagrams/studentSearchesForTournament.svg}{1.4}{1.4}{Student searches for Tournaments Sequence Diagram}
%\restoregeometry
\end{landscape}
\clearpage
...
\begin{enumerate}
    ...
    \item \textbf{Dispatcher Interface}
        \begin{enumerate}[label=$\bullet$]
            ...
            \item \textbf{getData(microserviceName: String): MicroserviceData} \label{meth:dispGetData}The method is invoked by a microservice to know the data of another microservice as discussed in: \nameref{parr:dispatcher}. The parameter is the name of the microservice that is requesting the data.
        \end{enumerate}
