...
\begin{enumerate}
    ...
    \item \textbf{Dispatcher Interface}
        \begin{enumerate}[label=$\bullet$]
            ...
            \item \textbf{MicroserviceData getData(String microserviceName)} \label{meth:dispGetData}The method is invoked by a microservice to know the data of an other microservice as discussed in: \nameref{parr:dispatcher}. The parameter is the name of the microservice that is requesting the data.
        \end{enumerate}
\end{enumerate}
