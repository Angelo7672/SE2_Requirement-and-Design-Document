...
that it is located in the DMZ. It is composed of the module:
\begin{enumerate}[label=$\bullet$]
...
This interaction is intended as placed everywhere there is a communication between an external component, or client and the Web server module.
