...
\begin{enumerate}
    ...
    \item \textbf{BadgeManager Interface}
        \begin{enumerate}[label=$\bullet$]
            \item \textbf{evluateCriteria(badge: BadgeData, tournament: TournamentData): Void} BadgeManager is invoked via this method to verify if some tests results meet criteria to assign a Badge to all eligible Students.
        \end{enumerate}
