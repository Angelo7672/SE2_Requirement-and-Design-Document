...
\clearpage
\useImgWithCaption{Images/UI/PNG/studentTournamentPage.png}{.5}{Student Homepage mockup}
\useImgWithCaption{Images/UI/PNG/studentTournamentPageStarted.png}{.5}{Student Homepage mockup}
\useImgWithCaption{Images/UI/PNG/studentBattlePage.png}{.5}{Student Homepage mockup}
\begin{table}
    \begin{tabu}{X[c, .5] X[c, .5]} 
