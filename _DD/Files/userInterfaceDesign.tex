...
\newpage
\useSvgWithCaption{Images/UI/SVG/educatorHomePage.svg}{.90}{.90}{Educator Homepage mockup}
\useSvgWithCaption{Images/UI/SVG/educatorCreatesTournament.svg}{.90}{.90}{Educator Homepage with create Tournament form mockup}
\clearpage
...
\useSvgWithCaption{Images/UI/SVG/studentHomePage.svg}{.90}{.90}{Student Homepage mockup}
\useSvgWithCaption{Images/UI/SVG/studentJoinsTournament.svg}{.90}{.90}{Student Homepage with more Tournament detail and subscription form mockup}
\clearpage
